                    ...
                    <div className={styles.chapList}>
                        ...
                        <div className={styles.chaps}>
                            {manga.chapters.en.map(scan => (
                                <Link key={scan+"en"} href={`/scans/${manga.titre}/read/En/${scan}`}>[{manga.titre}] Chapter {scan}</Link>
                            ))}
                        </div>
                    </div>
                    <div className={styles.chapList}>
                        ...
                        <div className={styles.chaps}>
                            ...
                            <Link key={scan+"raw"} href={`/scans/${manga.titre}/read/raw/${scan}`}>[{manga.titre}] Chapter {scan}</Link>
                            ))}
                        </div>
                    </div>
                </nav>
